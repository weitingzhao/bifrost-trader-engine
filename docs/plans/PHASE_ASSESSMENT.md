...
| **阶段 3**（数据获取） | ✅ **已完成实现** | ⏳ 待正式验收 | 2026-02-26 | — | **当前项目工作阶段**；R-A1、R-M6、R-H2 已落地；`scripts/check/stats_from_history.py` 历史统计 |
...
| TC-3-R-H2-1 | R-H2 | 人工/已实现 | `scripts/check/stats_from_history.py` 只读历史表；输出含按日/周对冲次数与盈亏相关；可离线运行 |
