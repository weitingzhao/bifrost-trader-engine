...
Options sync uses ``massive`` / ``massive_high``. Stock reference jobs use dedicated queues
...
STOCK_REFERENCE_KINDS: Final[frozenset[str]] = frozenset(
    {
