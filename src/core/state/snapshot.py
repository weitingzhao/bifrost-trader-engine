...
class StateSnapshot:
    ...
    O/D/M/L/E/S from state space; E can be from HedgeExecutionFSM or legacy ExecutionState.
    """
    ...
    M: MarketRegimeState
    L: LiquidityState
    E: ExecutionState  # from execution layer (HedgeExecutionFSM maps to E0..E4)
    S: SystemHealthState
    # Numeric
    net_delta: float
    option_delta: float
