...
export interface StrategyOpportunityPageProps {
  ...
  /** From URL param /strategy/opportunity/:id — open edit drawer for this opportunity. */
  urlFocusOpportunityId?: number | null
  /** Breadcrumb: Strategy home (Structure tab). */
  onNavigateToStrategy?: () => void
  /** Called when closing the opportunity form; should navigate back to /strategy/opportunity. */
  onCloseOppForm?: () => void
}
