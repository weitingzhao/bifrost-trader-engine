...
export interface StrategyInstancesPageProps {
  ...
  /** Instance id from URL param /strategy/instances/:id; when set, detail view is shown. */
  ...
  /** Called when opening instance detail; should navigate to /strategy/instances/:id. */
  onOpenInstanceDetail?: (id: number) => void
  /** Called when closing instance detail; should navigate to /strategy/instances. */
...
export function StrategyInstancesPage({
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onOpenInstanceDetail?.(res.strategy_instance_id)
    } catch (err) {
