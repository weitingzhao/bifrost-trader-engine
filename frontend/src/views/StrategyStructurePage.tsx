                        ...
                        {TEMPLATE_DIM_TYPES.map((dt) => (
                          <label key={dt} className={w9.structureTemplateFilterDim}>
                            ...
                            <AppSelect
                              ...
                              options={[
                                { value: '', label: 'Any' },
                                ...tplDimOptions[dt].map((code) => ({ value: code, label: code })),
                              ]}
                            />
                          </label>
                        ))}
            ...
            <div className="structure-copy-grid">
              <div className={cn(w9.structureDetailsPanel, 'structure-details-panel--span-2')}>
                ...
                <div className="structure-copy-template-block" style={{ marginTop: 'var(--space-2)' }}>
                  ...
                  <AppSelect
                    value={String(formPayload.strategy_template_id ?? '')}
                    onChange={(v) => {
                    ...
                    options={[
                      ...
                      ...copyTemplateSelectOptions.map((tpl) => ({
                        value: String(tpl.strategy_template_id),
                        label: `${tpl.display_name} (${tpl.template_code})`,
                      })),
                    ]}
                  />
      ...
      <section className="strategy-section">
        ...
        <div style={{ marginBottom: 'var(--space-2)' }}>
          ...
          <AppSelect
            ...
            value={String(historyStructureFilter)}
            onChange={(v) => setHistoryStructureFilter(v === '' ? '' : Number(v))}
            options={[
              { value: '', label: 'All' },
              ...structures.map((s) => ({
                value: String(s.strategy_structure_id),
                label: `${s.name} (${s.strategy_structure_id})`,
              })),
            ]}
          />
        </div>
