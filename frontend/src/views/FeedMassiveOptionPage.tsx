...
const MASSIVE_OPTION_COVERAGE_PLAN_URL = `${baseUrlForStaticAssets()}plans/massive_api_coverage.html`
                  ...
                  <div className="feed-massive-form-grid">
                    ...
                    <label className="feed-massive-field">
                      ...
                      <AppSelect
                        ...
                        value={ctListContractType}
                        onChange={v => setCtListContractType(v as '' | 'call' | 'put')}
                        disabled={ctListBusy || !configured}
                        options={[
                          { value: '', label: 'All' },
                  ...
                  <div className="feed-massive-form-grid">
                    ...
                    <label className="feed-massive-field">
                      ...
                      <AppSelect
                        className="form-input"
                        value={aggRight}
                        onChange={v => setAggRight(v as 'C' | 'P')}
                        disabled={aggBusy || !configured}
                        options={[
                          { value: 'C', label: 'Call' },
                          { value: 'P', label: 'Put' },
            ...
            >
              ...
              <div className="feed-massive-form-grid">
                ...
                <label className="feed-massive-field">
                  ...
                  <AppSelect
                    className="form-input"
                    value={chainContractType}
                    onChange={v => setChainContractType(v as '' | 'call' | 'put')}
                ...
                <label className="feed-massive-field">
                  ...
                  <AppSelect
                    className="form-input"
                    value={chainOrder}
                    onChange={v => setChainOrder(v as '' | 'asc' | 'desc')}
                    disabled={snapBusy || !configured}
                    options={[
                      { value: '', label: 'Default' },
            ...
            >
              ...
              <div className="feed-massive-form-grid">
                ...
                <label className="feed-massive-field">
                  ...
                  <AppSelect
                    className="form-input"
                    value={unifiedAssetType}
                    onChange={v => setUnifiedAssetType(v as typeof unifiedAssetType)}
                    disabled={snapBusy || !configured}
                    options={[
                      { value: '', label: 'All' },
                ...
                >
                  ...
                  <div className="feed-massive-form-grid">
                    ...
                    <label className="feed-massive-field">
                      ...
                      <AppSelect
                        className="form-input"
                        value={tqHistTradesSort}
                        onChange={v => setTqHistTradesSort(v as 'asc' | 'desc')}
                        disabled={tqHistTradesBusy || !configured || !massiveStatus?.trades_enabled}
                        options={[
                          { value: 'asc', label: 'Ascending' },
                          { value: 'desc', label: 'Descending' },
                ...
                >
                  ...
                  <div className="feed-massive-form-grid">
                    ...
                    <label className="feed-massive-field">
                      ...
                      <AppSelect
                        className="form-input"
                        value={tqHistQuotesSort}
                        onChange={v => setTqHistQuotesSort(v as 'asc' | 'desc')}
                        disabled={tqHistQuotesBusy || !configured}
                        options={[
                          { value: 'asc', label: 'Ascending' },
                          { value: 'desc', label: 'Descending' },
