...
export function ResearchApisPage({ embeddedInSettings }: ResearchApisPageProps) {
  ...
  const researchMsgClearRef = useRef<ReturnType<typeof setTimeout> | null>(null)
  const strategyMsgClearRef = useRef<ReturnType<typeof setTimeout> | null>(null)
  const marketMsgClearRef = useRef<ReturnType<typeof setTimeout> | null>(null)
