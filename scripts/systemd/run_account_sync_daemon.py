...
Strategy Trading Daemon.  Uses Redis Stream XREADGROUP for incremental consumption.

Production / systemd entry (same as ``scripts/check/run_account_sync_daemon.py``).

Usage::
  python scripts/systemd/run_account_sync_daemon.py
